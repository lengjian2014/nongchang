...
jQuery(function($){
	//创建DOM
	var 
	quickHTML = '<div class="quick_links_panel"><div id="quick_links" class="quick_links"><a href="#top" class="return_top"><i class="top"></i><span>返回</span></a><a href="#" class="my_qlinks"><i class="setting"></i><span>用户</span></a><a href="#" class="message_list" ><i class="message"></i><span>消息</span><em class="num" style="display:none"></em></a><a href="#" class="history_list"><i class="view"></i><span>浏览</span></a><a href="#" class="leave_message"><i class="qa"></i><span>客服</span></a></div><div class="quick_toggle"><a href="javascript:;" class="toggle" title="展开/收起">×</a></div></div><div id="quick_links_pop" class="quick_links_pop hide"></div>',
